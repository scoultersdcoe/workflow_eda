...
If you believe that most of the student data is accurate, having inaccurate data for one or two percent of your dataset is unlikely to bias your results if you are interested in analyzing patterns in the data rather than developing individual accountability results. Rather than calling a halt to the data cleaning work, it makes sense to proceed by applying a decision rule to choose a single test score record in cases where there are near-duplicates. 
